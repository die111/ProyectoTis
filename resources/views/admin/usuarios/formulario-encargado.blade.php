      ...
      <form action="{{ route('admin.usuarios.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div>
            ...
            <input id="last_name_father" type="text" name="last_name_father" placeholder="Ingrese su apellido paterno" required
                   class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-gray-400">
          ...
          <div class="relative">
            ...
            <!-- caret (usa Bootstrap Icons si ya lo cargas) -->
          ...
          <div class="relative">
            ...
            <button
              ...
              <!-- ojo tachado (oculto al inicio) -->
              <svg id="icon-eye-off" xmlns="http://www.w3.org/2000/svg" class="hidden h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
