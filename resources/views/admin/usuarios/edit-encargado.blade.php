          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div class="relative">
              ...
              <button type="button" id="togglePasswordEdit"
                ...
                <!-- ojo -->
                <svg id="icon-eye-edit" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2">
                  <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z" />
                  <circle cx="12" cy="12" r="3" />
                </svg>
                <!-- ojo tachado -->
                <svg id="icon-eye-off-edit" xmlns="http://www.w3.org/2000/svg" class="hidden h-5 w-5" viewBox="0 0 24 24"
