      ...
      <form action="{{ route('admin.usuarios.update', $user->id) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div class="relative">
            ...
            <input id="password_edit" name="password" type="password" placeholder="De14697@"
            ...
            <button type="button"
              ...
              <!-- ojo -->
              <svg id="icon-eye-edit" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/>
                <circle cx="12" cy="12" r="3"/>
              </svg>
              <!-- ojo tachado -->
              <svg id="icon-eye-off-edit" xmlns="http://www.w3.org/2000/svg" class="hidden h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<script>
  (function () {
    ...
    const btn = document.getElementById('togglePasswordEdit');
    const eye = document.getElementById('icon-eye-edit');
    const eyeOff = document.getElementById('icon-eye-off-edit');
