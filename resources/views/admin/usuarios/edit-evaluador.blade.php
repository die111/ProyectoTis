      ...
      <form action="{{ route('admin.usuarios.update', $user->id) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div class="relative">
            ...
            <input id="password_edit_eval" name="password" type="password" placeholder="De14697@"
            ...
            <button type="button"
              ...
              <!-- ojo -->
              <svg id="icon-eye-edit-eval" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/>
                <circle cx="12" cy="12" r="3"/>
              </svg>
              <!-- ojo tachado -->
              <svg id="icon-eye-off-edit-eval" xmlns="http://www.w3.org/2000/svg" class="hidden h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <div class="relative">
            ...
            <select id="level" name="level"
              ...
              <option value="Preuniversitario" {{ $user->level == 'Preuniversitario' ? 'selected' : '' }}>Preuniversitario</option>
            </select>
            <i class="bi bi-chevron-down absolute right-3 top-9 pointer-events-none text-gray-500"></i>
          </div>
